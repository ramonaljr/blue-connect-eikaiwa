    ...
    return (
      <Card className="w-full max-w-md border-none shadow-none lg:shadow-elevated lg:border lg:border-border">
        <CardHeader className="text-center">
          <div className="mx-auto mb-2 flex size-14 items-center justify-center rounded-full bg-[oklch(0.65_0.18_155)]/10">
            <CheckCircle className="size-7 text-[oklch(0.65_0.18_155)]" />
          </div>
          <CardTitle className="text-2xl font-bold">{tc('success')}</CardTitle>
